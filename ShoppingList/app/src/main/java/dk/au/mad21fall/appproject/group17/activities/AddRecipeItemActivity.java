...
public class AddRecipeItemActivity extends AppCompatActivity implements AddItemAdapter.IAddItemClickedListener {
    private static final String TAG = "AddRecipeItemActivity";
    ...
    private void addItemToRecipe() {
        if (addItemAmount.getText().toString().isEmpty())
        {
            Toast.makeText(this, R.string.addRecipeAmountToast, Toast.LENGTH_SHORT).show();
        } else{
            ...
            resultIntent.putExtra("addItem", true);
            resultIntent.putExtra("itemToAddUid", selectedItem.getUid());
            resultIntent.putExtra("addItemName", selectedItem.getName());
            resultIntent.putExtra("addItemAmount", selectedItem.getAmount());
            resultIntent.putExtra("addItemPicture", selectedItem.getPictureUrl());

            Toast.makeText(this, selectedItem.getName() + " " + getResources().getString(R.string.addRecipeConfirmedToast), Toast.LENGTH_SHORT).show();
